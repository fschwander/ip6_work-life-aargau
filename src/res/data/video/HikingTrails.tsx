...
import {VideoOverlayMixin} from './VideoOverlayMixin';

export class HikingTrails extends VideoOverlayMixin {
  initGraph(): HTMLDivElement {
    throw new Error("Method not implemented.");
  }

  get getData(): VideoOverlayInterface {
    return {
