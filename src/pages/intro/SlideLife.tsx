...
export const SlideLife: React.FC<SlideProps> = props => {
  ...
  return (
    <div className={rootClass}
      ...
      <QuizBox question={questions.reputation} lineLength={140} lineRotationInDeg={300} orientation='left'/>
      <QuizBox question={questions.history} lineLength={130} lineRotationInDeg={235} orientation='left'/>
      <QuizBox question={questions.sport} lineLength={80} lineRotationInDeg={40} orientation='right'/>
